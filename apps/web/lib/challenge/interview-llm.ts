...
export async function runChallengeInterviewTurn(params: {
  ...
  const system = `אתה אלמוג, מנטור AI באתגר 14 יום של NuraWell.
...
שאל שאלה אחת בכל פעם. דבר כמו חבר בגובה עיניים — כנות, לא ריצוי, לא הרצאה. כמה משפטים אמיתיים, לא מברק.
