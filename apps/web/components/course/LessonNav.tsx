    ...
    <div className="guide-glass-card p-4">
      <div className="flex items-center gap-3">
        ...
        {prevLesson ? (
          ...
          >
            <ChevronRight className="w-4 h-4 text-white/60 group-hover:text-white flex-shrink-0 transition-colors" />
            <div className="min-w-0">
              <p className="text-xs text-white/65">פרק קודם</p>
              <p className="text-sm text-white/85 group-hover:text-white font-medium line-clamp-1 transition-colors">
                {prevLesson.title}
              </p>
            </div>
          </Link>
        ...
        {nextLesson ? (
          ...
          >
            <div className="min-w-0 flex-1">
              <p className="text-xs text-white/65 text-left">פרק הבא</p>
              <p className="text-sm text-white/85 group-hover:text-white font-medium line-clamp-1 transition-colors text-left">
                {nextLesson.title}
              </p>
            </div>
            <ChevronLeft className="w-4 h-4 text-white/60 group-hover:text-white flex-shrink-0 transition-colors" />
          </Link>
        ) : (
          <div className="flex-1" />
        )}
