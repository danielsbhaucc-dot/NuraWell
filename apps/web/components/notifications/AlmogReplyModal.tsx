      ...
      {open && detail && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-3 bottom-[max(1rem,env(safe-area-inset-bottom))] z-[270] mx-auto w-full max-w-md overflow-hidden rounded-[28px] border border-emerald-200/60 bg-white shadow-2xl sm:inset-x-auto sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2"
            dir="rtl"
          >
            <motion.div
